...
const OfferCard: React.FC<OfferCardProps> = ({
  ...
  const { addToCart, setAppliedOffer } = useCart();
      ...
      {!isAutoApplied && (
        <>
          {qty === 0 ? (
              ...
              onClick={() => {
                if (offer.couponCode) {
                  ...
                  if (setAppliedOffer) {
                    ...
                    alert("Coupon '" + offer.couponCode + "' Applied successfully! 🎉 Check your cart.");
                  }
                } else {
                  // Add as an Item bundle
                  setQty(1);
                  addToCart({
                    id: offer.id,
                    name: title,
            ...
            >
              {offer.couponCode ? "Apply Coupon" : "Add to Cart"}
            </button>
          ) : (
