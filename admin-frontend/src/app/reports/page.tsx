...
export default function ReportsPage() {
  ...
  const reports: ReportMeta[] = [
    ...
    },
    {
      ...
      description: 'Daily revenue overview across outlets showing bill counts, discount rates, tax sums, and service fees.',
      path: '/reports/daily-sales',
      icon: <TrendingUp size={24} />,
      color: 'bg-emerald-500/10 text-emerald-700 ring-emerald-200',
    },
    {
      id: 'cancel-orders',
      title: 'Cancel Order Report',
      description: 'Analyze order cancellations by day and outlet in matrices detailing quantity count and value sum.',
