...
export default function MenuPage() {
  ...
  const handleSaveCustomizations = async () => {
    if (!editingCustProduct || !selectedOutletId) return

    setIsSaving(true)
    try {
      await updateProduct(selectedOutletId, editingCustProduct.id, {
      ...
      <main className="flex-1 bg-background overflow-auto">
        <div className="p-8">
          ...
          <div className="border border-border rounded-lg p-6">
            {/* Select Outlet Dropdown — Admin Only */}
            <div className="mb-6">
            ...
            <div className="border border-border rounded overflow-hidden">
              ...
              <div className="divide-y divide-border">
                {filteredProducts.length > 0 ? (
                  ...
                  <div className="grid grid-cols-9 min-h-[80px] items-center">
                    <div className="col-span-9 p-3 text-center text-muted-foreground">
